...
import EditarImagenBebida from "./EditarImagenBebida"
...
useEffect(() => {
  if (imagenesBebidas) {
    const currentImagenes = imagenesBebidas.slice(
      indexOfFirstImagen,
      indexOfLastImagen
    );
    setImagenesMostrar(currentImagenes);
  }
}, [imagenesBebidas, indexOfFirstImagen, indexOfLastImagen]);
...
const eliminarImagen = (id) => {
  ...
  return (
    <>
        ...
        <EditarImagenBebida show={show} setShow={setShow} handleClose={handleClose} />
      </div>
      <div className="pagination d-flex justify-content-center">
        {imagenesBebidas &&
          imagenesBebidas.length > imagenesPerPage &&
          Array.from({
            length: Math.ceil(imagenesBebidas.length / imagenesPerPage),
          }).map((_, index) => (
